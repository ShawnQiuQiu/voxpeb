...
export const translations = {
  en: {
    ...
    dash_desc: "Track your speaking performance synced from your Voxpeb device.",
    dash_avg_score: "Average Score",
    dash_total_time: "Total Speaking Time",
    ...
    dash_pronunciation: "Pronunciation",
    dash_fluency: "Fluency",
    dash_vocabulary: "Vocabulary",
  ...
  zh: {
    ...
    dash_title: "我的进度",
    dash_desc: "追踪从您的 Voxpeb 设备同步的口语表现。",
    dash_avg_score: "平均分",
    dash_total_time: "总口语时长",
    dash_streak: "当前连续打卡",
    dash_trend: "分数趋势",
    dash_latest: "最新指标",
  ...
  ja: {
    ...
    dash_title: "私の進捗",
    dash_desc: "Voxpebデバイスから同期されたスピーキングパフォーマンスを追跡します。",
    dash_avg_score: "平均スコア",
    dash_total_time: "合計スピーキング時間",
    dash_streak: "現在の連続学習",
    dash_trend: "スコアの傾向",
    dash_latest: "最新の指標",
  ...
  es: {
    ...
    dash_desc: "Rastrea tu rendimiento de habla sincronizado desde tu dispositivo Voxpeb.",
    dash_avg_score: "Puntuación Media",
    dash_total_time: "Tiempo Total de Habla",
    dash_streak: "Racha Actual",
    dash_trend: "Tendencia de Puntuación",
    ...
    dash_overall: "General",
    dash_feedback: "Comentarios",
    dash_pronunciation: "Pronunciación",
    dash_fluency: "Fluidez",
    dash_vocabulary: "Vocabulario",
    dash_grammar: "Gramática",
    dash_min: "min",
    dash_days: "días",
    footer_copy: "Voxpeb (语珀) © 2025",
  ...
  fr: {
    ...
    dash_desc: "Suivez vos performances d'expression orale synchronisées depuis votre appareil Voxpeb.",
    dash_avg_score: "Score Moyen",
    dash_total_time: "Temps de Parole Total",
    dash_streak: "Série Actuelle",
    dash_trend: "Tendance du Score",
    ...
    dash_pronunciation: "Prononciation",
    dash_fluency: "Fluidité",
    dash_vocabulary: "Vocabulaire",
    dash_grammar: "Grammaire",
    dash_min: "min",
    dash_days: "jours",
    footer_copy: "Voxpeb (语珀) © 2025",
