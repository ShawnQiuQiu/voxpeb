...
export const translations = {
  en: {
    ...
    dash_desc: "Track your TOEFL speaking performance synced from your Voxpeb device.",
    dash_avg_score: "Estimated Score",
    dash_total_time: "Total Practice Time",
    dash_streak: "Current Streak",
    dash_trend: "Score Trend (0-30)",
    dash_latest: "Latest Metrics",
    dash_latest_desc: "Based on your most recent session",
    dash_recent: "Recent Sessions",
    dash_view_all: "View All",
    dash_overall: "Total Score",
    dash_feedback: "Feedback",
    dash_delivery: "Delivery",
    dash_language: "Language Use",
    dash_topic: "Topic Development",
    dash_transcript: "Transcript",
    dash_task_independent: "Independent Task",
    dash_task_integrated: "Integrated Task",
    dash_min: "min",
    dash_days: "days",
  ...
  zh: {
    ...
    dash_title: "我的进度",
    dash_desc: "追踪从您的 Voxpeb 设备同步的托福口语表现。",
    dash_avg_score: "预估分数",
    dash_total_time: "总练习时长",
    dash_streak: "当前连续打卡",
    dash_trend: "分数趋势 (0-30)",
    dash_latest: "最新指标",
    dash_latest_desc: "基于您最近一次的练习",
    dash_recent: "最近练习",
    dash_view_all: "查看全部",
    dash_overall: "总分",
    dash_feedback: "反馈建议",
    ...
    dash_language: "语言使用",
    dash_topic: "话题展开",
    dash_transcript: "录音文本",
    dash_task_independent: "独立口语",
    dash_task_integrated: "综合口语",
    dash_min: "分钟",
    dash_days: "天",
    footer_copy: "Voxpeb (语珀) © 2025",
  ...
  ja: {
    ...
    dash_title: "私の進捗",
    dash_desc: "Voxpebデバイスから同期されたTOEFLスピーキングパフォーマンスを追跡します。",
    dash_avg_score: "予想スコア",
    dash_total_time: "総練習時間",
    dash_streak: "現在の連続学習",
    dash_trend: "スコアの傾向 (0-30)",
    dash_latest: "最新の指標",
    dash_latest_desc: "最新のセッションに基づく",
    dash_recent: "最近のセッション",
    dash_view_all: "すべて表示",
    dash_overall: "合計スコア",
    dash_feedback: "フィードバック",
    dash_delivery: "デリバリー",
    dash_language: "言語使用",
    dash_topic: "トピック展開",
    dash_transcript: "トランスクリプト",
    dash_task_independent: "独立スピーキング",
    dash_task_integrated: "統合スピーキング",
    dash_min: "分",
    dash_days: "日",
    footer_copy: "Voxpeb (语珀) © 2025",
  ...
  es: {
    ...
    dash_title: "Mi Progreso",
    dash_desc: "Rastrea tu rendimiento de habla TOEFL sincronizado desde tu dispositivo Voxpeb.",
    dash_avg_score: "Puntuación Estimada",
    dash_total_time: "Tiempo Total de Práctica",
    dash_streak: "Racha Actual",
    dash_trend: "Tendencia de Puntuación (0-30)",
    dash_latest: "Últimas Métricas",
    dash_latest_desc: "Basado en tu sesión más reciente",
    dash_recent: "Sesiones Recientes",
    dash_view_all: "Ver Todo",
    dash_overall: "Puntuación Total",
    dash_feedback: "Comentarios",
    dash_delivery: "Entrega",
    dash_language: "Uso del Lenguaje",
    dash_topic: "Desarrollo del Tema",
    dash_transcript: "Transcripción",
    dash_task_independent: "Tarea Independiente",
    dash_task_integrated: "Tarea Integrada",
    dash_min: "min",
    dash_days: "días",
    footer_copy: "Voxpeb (语珀) © 2025",
  ...
  fr: {
    ...
    dash_title: "Mes Progrès",
    dash_desc: "Suivez vos performances TOEFL synchronisées depuis votre appareil Voxpeb.",
    dash_avg_score: "Score Estimé",
    dash_total_time: "Temps Total de Pratique",
    dash_streak: "Série Actuelle",
    dash_trend: "Tendance du Score (0-30)",
    dash_latest: "Dernières Métriques",
    dash_latest_desc: "Basé sur votre session la plus récente",
    dash_recent: "Sessions Récentes",
    dash_view_all: "Voir Tout",
    dash_overall: "Score Total",
    dash_feedback: "Commentaires",
    dash_delivery: "Prestation",
    dash_language: "Utilisation de la Langue",
    dash_topic: "Développement du Sujet",
    dash_transcript: "Transcription",
    dash_task_independent: "Tâche Indépendante",
    dash_task_integrated: "Tâche Intégrée",
    dash_min: "min",
    dash_days: "jours",
    footer_copy: "Voxpeb (语珀) © 2025",
